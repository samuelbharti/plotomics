...
#' runtime (`window.bioviz`) expects and hands it to [htmlwidgets::createWidget()].
...
#'   `window.bioviz` and the binding/yaml file names.
...
#' @keywords internal
#' @noRd
bioviz_widget <- function(name, columns, meta = list(), options = list(),
